...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/xTaR_Force_Sub")        ],
    ]
)
...
async def start(bot: Client, m: Message):
    ...
    [
        InlineKeyboardButton("xTaR", url="https://t.me/xTaR_Force_Sub")
    ],
    [
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        ...
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/imxTaR")
        ]])
    )
